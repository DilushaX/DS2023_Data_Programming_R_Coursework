...
data_clean <- data_clean %>%
  mutate(
    ...
    stage_highest_recorded = case_when(
      str_detect(stage_highest_recorded, "1-3") ~ "Stage I–III",
...
```{r}
file.exists("data/clean_data.csv")
```

## Data Cleaning – Conclusion

  The dataset contained missing values, inconsistencies, and noisy NLP-derived fields. Through systematic cleaning, filtering, and proper formatting, the data was transformed into a structured and analysis-ready format. This step was essential to ensure accurate modeling and reliable results in later stages of the project.
